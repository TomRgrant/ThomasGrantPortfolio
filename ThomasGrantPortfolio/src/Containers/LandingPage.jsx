    ...
    return(
        <>
            <div className="landing-wrapper">
                <h1 className="hero fade-in">Hi, I'm <span>Thomas Grant</span></h1>
                <p className="fade-in delay-1 hero-sub">A curious full-stack developer solving real problems with clean code.</p>
                <button class="cta fade-in delay-2" onclick="document.getElementById('projects').scrollIntoView({ behavior: 'smooth' })"> 
                    View My Work 
                </button>
                
      <div class="social-links fade-in delay-3">
        <a href="https://github.com/TomRgrant" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
        ...
        <a href="https://www.linkedin.com/in/thomasgrant0" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <svg viewBox="0 0 24 24" fill="currentColor" class="icon" aria-hidden="true">
